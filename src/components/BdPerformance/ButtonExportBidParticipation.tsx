...
export default function ButtonExportBidParticipation({
  id,
  startDate,
  endDate,
}: {
  ...
  const downloadCSV = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/api/bd-performances/dealer-bid-participation/${id}/export?start_date=${startDate}&end_date=${endDate}`,
        {
          method: "GET",
          headers: {
